...
Diretor::Diretor(string areaSupervisao, string areaFormacao, string codFuncionario, string nome, string endereco, string telefone, string designacao, tm dataIngresso, double salario)
